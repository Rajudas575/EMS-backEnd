...
export const downloadPayslip = async (req, res) => {
  try {
    ...
    const user = await User.findById(userId).populate("category_id", "category");
    ...
    doc
      .fontSize(10)
      .text("Zoonodle Inc", { align: "center" })
      .text("21023 Pearson Point Road", { align: "center" })
    ...
    const rows = [
      ...
      ["Incentive Pay", payroll.incentive || 0, "Professional Tax", payroll.professionalTax || 0],
      ["House Rent Allowance", payroll.hra, "Loan", payroll.loan || 0],
    ...
    doc.text(payroll.deductions, col4 + 5, rowY + 5);
